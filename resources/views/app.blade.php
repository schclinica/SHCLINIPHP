...
@section('contenido')
   {{-- medico --}}
    @if ($this->profile()->rol === 'Médico')
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 my-1">
                <div class="card text-white" style="background: -webkit-linear-gradient(90deg, #29d6d4,#00b7e1,#0093e3,#3068cd,#77309a);background: linear-gradient(90deg, #29d6d4,#00b7e1,#0093e3,#3068cd,#77309a);">
                    <div class="card-body">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 my-1">
                <div class="card text-white" style="background: -webkit-linear-gradient(90deg, #fffc41,#96d35f);background: linear-gradient(90deg, #fffc41,#96d35f);">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 my-1">
                <div class="card text-white" style="background: -webkit-linear-gradient(90deg, #ffd700,#ff8c00,#ff4500);background: linear-gradient(90deg, #ffd700,#ff8c00,#ff4500);">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                                <img src="{{ $this->asset('img/icons/unicons/money.ico') }}" alt="chart success"
    ...
    @endif
    {{---ADMISION Y ENFEREMERA DE TRIAJE----}}
    @if ($this->profile()->rol === 'Admisión' || $this->profile()->rol === 'Enfermera-Triaje')
        <div class="row">
            <div class="col-xl-2 col-md-6 col-sm-6 col-12 my-1">
                <div class="card text-white" style="background: linear-gradient(to bottom, #f2825b 0%,#e55b2b 50%,#f07146 100%);">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
            ...
            <div class="col-xl-2 col-md-6 col-sm-6 col-12 my-1">
                <div class="card text-white" style="background: linear-gradient(to bottom, #9dd53a 0%,#a1d54f 50%,#80c217 51%,#7cbc0a 100%);">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                                <img src="{{ $this->asset('img/icons/unicons/money.ico') }}" alt="chart success"
                        ...
                        <span class="fw-semibold d-block mb-1 text-center">CITAS CONFIRMADOS</span>
            ...
            <div class="col-xl-2  col-md-6 col-sm-6 col-12 my-1">
                <div class="card text-white" style="background:linear-gradient(to bottom, #ffb76b 0%,#ffa73d 50%,#ff7c00 51%,#ff7f04 100%);">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                        ...
                        <span class="fw-semibold d-block mb-1 text-center">CITAS PENDIENTES</span>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 my-1">
                <div class="card text-white" style="background:linear-gradient(to bottom, #b3dced 0%,#29b8e5 50%,#bce0ee 100%);">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
            ...
            <div class="col-xl-3 col-lg-3 col-12 my-1">
                <div class="card text-white" style="background:linear-gradient(to bottom, #d0e4f7 0%,#73b1e7 24%,#0a77d5 50%,#539fe1 79%,#87bcea 100%);">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                                <img src="{{ $this->asset('img/icons/unicons/medico.ico') }}" alt="chart success"
                        ...
                        <span class="fw-semibold d-block mb-1 text-center">CITAS FINALIZADOS</span>
    ...
    @if ($this->profile()->rol === 'Director' || $this->profile()->rol === 'admin_general')
        <div class="row mb-2">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 my-1">
                <div class="card text-white" style="background: -webkit-linear-gradient(90deg, #ff5196,#ff1a3d,#ff7913);background: linear-gradient(90deg, #ff5196,#ff1a3d,#ff7913);">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                                <img src="{{ $this->asset('img/icons/unicons/citas.ico') }}" alt="chart success"
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 my-1">
                <div class="card" style="background: -webkit-linear-gradient(90deg, #d2d057,#a8bf3d,#7aae27);background: linear-gradient(90deg, #d2d057,#a8bf3d,#7aae27);">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                                <img src="{{ $this->asset('img/icons/unicons/paciente.ico') }}" alt="chart success"
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 my-1">
                <div class="card" style="background: -webkit-linear-gradient(90deg, #f5e91f,#ff8111);background: linear-gradient(90deg, #f5e91f,#ff8111);">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                                <img src="{{ $this->asset('img/icons/unicons/notificacion.ico') }}" alt="chart success"
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 my-1">
                <div class="card" style="background: -webkit-linear-gradient(90deg, #c7f2ff,#5cd3ff);background: linear-gradient(90deg, #c7f2ff,#5cd3ff);">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                                <img src="{{ $this->asset('img/icons/unicons/users.ico') }}"
                                    alt="chart success" class="rounded" />
                            </div>
                            <div class="dropdown">
                                <button class="btn p-0" type="button" id="cardOpt3" data-bs-toggle="dropdown"
            ...
            <div class="col-xl-4 col-lg-4  col-12 my-1">
                <div class="card" style="background: -webkit-linear-gradient(90deg, #ee2046,#fa1c44,#fb3c5f);background: linear-gradient(90deg, #ee2046,#fa1c44,#fb3c5f);">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                                <img src="{{ $this->asset('img/icons/unicons/users.ico') }}"
                ...
                columns: [{
                    ...
                    }},
                    {
                        "data":"estadodata",render:function(estadodata){
                            ...
                            {
                                return '<span class="badge bg-warning">En Triaje</span>'
                            }
                            else{
                                if(estadodata === 'pendiente'){
                                    return '<span class="badge bg-danger">Cita pendiente</span>'
                                }else{
                ...
                success: function(response) {
                    response = JSON.parse(response);
                        response.response.forEach(data_ => {
                            Data_Doc.push([""+data_.mes+"",parseInt(data_.cantidad)]);
                        });
                    
                    GenerateGraficoEstadistico(Data_Doc, 'reporte_pacientes_atendidos_mes_medico_sistema', '# de pacientes atendidos por mes ( {{ $this->FechaActual("Y") }} )');
